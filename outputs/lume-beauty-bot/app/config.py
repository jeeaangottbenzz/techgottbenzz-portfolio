...
def load_config() -> Config:
    ...
    database_path = Path(os.getenv("DATABASE_PATH", "data/lume_beauty.sqlite3"))

    if not token:
        raise RuntimeError("BOT_TOKEN не задан. Скопируйте .env.example в .env и добавьте токен бота.")
